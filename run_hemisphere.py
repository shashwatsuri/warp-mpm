...
for k in range(0,100):
    # save_data_at_frame(mpm_solver, directory_to_save, k, save_to_ply=False, save_to_h5=False)
...
#     mpm_solver.p2g2p(k, 0.002, device=dvc)
#     save_data_at_frame(mpm_solver, directory_to_save, k, save_to_ply=True, save_to_h5=False,save_to_usd=True)
